...
RSpec.describe LastLLM::Providers::Ollama do
  ...
  describe '#generate_text' do
    it 'returns text completion from Ollama' do
      VCR.use_cassette('ollama/generate_text', match_requests_on: %i[method uri]) do
    ...
    describe 'with system prompt' do
      ...
      it 'handles system prompts correctly' do
        ...
        result = nil
        VCR.use_cassette('ollama/generate_text_with_system', match_requests_on: %i[method uri]) do
        ...
        standard_result = nil
        VCR.use_cassette('ollama/generate_text_comparison', match_requests_on: %i[method uri]) do
